...
MODEL_NAME="swin_uper"
LOSS_TYPE="fs_auxohemce_loss"
CHECKPOINTS_NAME="${BACKBONE}_${MODEL_NAME}_ohem_adamw_lr1e4_dp03_$(date +%F_%H-%M-%S)"
LOG_FILE="./log/cityscapes/${CHECKPOINTS_NAME}.log"
echo "Logging to $LOG_FILE"
mkdir -p `dirname $LOG_FILE`

PRETRAINED_MODEL="./pretrained_model/swin_tiny_patch4_window7_224.pth"
