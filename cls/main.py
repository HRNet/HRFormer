...
def train_one_epoch(
    ...
    lr_scheduler,
    total_epoch,
    total_epoch_num=V.total_epoch_num,
    epoch_num=V.epoch_num,
):
    S.assign(total_epoch_num, total_epoch)
    S.assign(epoch_num, epoch)
...
def validate(config, data_loader, model):
    ...
    logger.info(
        f" * Loss {loss_meter.avg:.3f} Acc@1 {acc1_meter.avg:.3f} Acc@5 {acc5_meter.avg:.3f}"
    )
