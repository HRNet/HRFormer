...
PRETRAINED_MODEL="./hrt_pretrained_models/hrt_small.pth" # Replace with the path to pre-trained backbone
...
if [ "$1"x == "train"x ]; then
  ...
  ${PYTHON} -u main.py --configs ${CONFIGS_TEST} --drop_last y --data_dir ${DATA_DIR} \
                       ...
                       --phase test --gpu 0 1 2 3 4 5 6 7 --resume ./checkpoints/cityscapes/${CHECKPOINTS_NAME}_max_performance.pth \
